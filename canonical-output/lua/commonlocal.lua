...
base_language_info["fr"]["error.missing"] = 'Traduction manquante'
base_language_info["fr"]["error.na"] = 'Langue indisponible'
base_language_info["fr"]["error.na.in"] = 'Non disponible en $1'
...
function CommonLocal.new(defaultLanguage)
    ...
    self.languageList = {'en', 'ar', 'bg', 'de', 'el', 'eo', 'es', 'fi', 'fr', 'he', 'hi', 'hu', 'it', 'ja', 'ko', 'la', 'nl', 'pl', 'pt', 'pt_br', 'ru', 'sv', 'th', 'tr', 'uk', 'zh', 'sk'}
